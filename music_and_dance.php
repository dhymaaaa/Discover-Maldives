    ...
    <div class="main_content dance_and_music">
        <div class="music_main">
            ...
            <div class="music">
                ...
                <div>
                    <h3>Boduberu</h3>
                    <p>It starts with a slow beat and soft tempo which is increased until it becomes fast-paced drumming. This dance is traditionally performed by a group of 15 people with 1 lead singer, 3 drummers and dancers.</p>
            ...
            <div class="music">
                ...
                <div>
                    <h3>Thaara Jehun</h3>
                    <p>Thaara Jehun can be described as the Maldivian version of tambourines. The performance includes about 22 men arranged in two rows, singing and beating drums, while others dance in time to the music. It is a very special form of entertainment, reserved for national events and celebratory occasions.</p>
                </div>
            </div>
        </div>
    </div>
